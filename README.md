...
docker build -t ghcr.io/arisudesu-dev/quote-bot:latest -t ghcr.io/arisudesu-dev/quote-bot:v0.32.5-arisu3 -f quote-bot.Dockerfile .
...
docker push ghcr.io/arisudesu-dev/quote-bot:v0.32.5-arisu3
